...
export const getStudyPlanList = () => api.get<StudyPlanSummary[]>(ENDPOINT);

export const getStudyPlan = (studyPlanId: number) => api.get<StudyPlan>([ENDPOINT, studyPlanId]);
...
export const editStudyPlanDetails = ({
  studyPlanId,
  studyPlanDetails,
}: {
  studyPlanId: number;
...
export const addCoursesToStudyPlan = ({
  courseIds,
  sectionId,
  studyPlanId,
}: {
...
export const editSectionDetails = ({
  sectionDetails,
  sectionId,
  studyPlanId,
}: {
...
export const removeCoursesFromStudyPlan = ({
  courseIds,
  studyPlanId,
}: {
  courseIds: number[];
...
export const linkPrerequisitesToCourse = ({
  studyPlanId,
  courseId,
  prerequisites,
  relation,
...
export const unlinkPrerequisiteFromCourse = ({
  studyPlanId,
  courseId,
  prerequisiteId,
}: {
...
export const linkCorequisitesToCourse = ({
  studyPlanId,
  courseId,
  corequisiteIds,
}: {
...
export const unlinkCorequisiteFromCourse = ({
  studyPlanId,
  courseId,
  corequisiteId,
}: {
...
export const moveCoursesToSection = ({
  studyPlanId,
  courseIds,
  targetSectionId,
}: {
...
export const resizeCoursePlacement = ({
  studyPlanId,
  courseId,
  span,
}: {
...
export const placeCoursesInSemester = ({
  studyPlanId,
  targetPlacement,
  courseIds,
}: {
...
export const removeCourseFromSemester = ({
  studyPlanId,
  courseId,
}: {
  studyPlanId: number;
